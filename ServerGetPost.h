...
class ServerGetPost
{
  public:
    ...
    // Variables
    /* Urls for functions */
    String sendSamplesURL = "/Plant/UpdateMeasure"; // to send smaples 
    String newResearchURL = "/Research/GetNewResearchByIp?plantIp=987.456.987.456&envStatus="; //for research ID
